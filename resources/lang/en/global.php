...
return [
    ...
    'menu'                              => [
        ...
        'fields'         => [
            ...
            'status'                        => 'Status',
            'status_helper'                 => '',
            'cooking_date'                  => 'Cooking Date',
            'cooking_date_helper'           => '',
            'delivery_itself'               => 'Delivery Itself',
            'delivery_itself_helper'        => '',
            'free_delivery_radius'          => 'Free Delivery Radius',
            'free_delivery_radius_helper'   => 'Бесплатная доставка в радиусе',
            'free_delivery_amount'          => 'Free Delivery Amount',
            'free_delivery_amount_helper'   => 'Минимальная сумма заказа для бесплатной доставки',
            'created_at'                    => 'Created At',
            'created_at_helper'             => '',
            'updated_at'                    => 'Updated At',
            'updated_at_helper'             => '',
